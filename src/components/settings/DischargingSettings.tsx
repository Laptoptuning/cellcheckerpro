...
const DischargingSettings = ({
  settings,
  onSettingChange
}: DischargingSettingsProps) => {
      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input id="cutoffVoltage" type="number" step="0.1" value={settings.cutoffVoltage} onChange={e => onSettingChange('cutoffVoltage', e.target.value)} className="bg-neutral-700 border-neutral-600" />
          ...
          <div className="space-y-2">
            ...
            <Input id="dischargeCurrent" type="number" step="0.1" value={settings.dischargeCurrent} onChange={e => onSettingChange('dischargeCurrent', e.target.value)} className="bg-neutral-700 border-neutral-600" />
          ...
          <div className="space-y-2">
            ...
            <Input id="maxDischargeTemp" type="number" value={settings.maxTemperature} onChange={e => onSettingChange('maxTemperature', e.target.value)} className="bg-neutral-700 border-neutral-600" />
