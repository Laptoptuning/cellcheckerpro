      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input id="storageVoltage" type="number" step="0.1" value={settings.storageVoltage} onChange={e => onSettingChange('storageVoltage', e.target.value)} className="bg-neutral-700 border-neutral-600" />
          ...
          <div className="space-y-2">
            ...
            <Input id="maxCellsPerTest" type="number" value={settings.maxCellsPerTest} onChange={e => onSettingChange('maxCellsPerTest', e.target.value)} className="bg-neutral-700 border-neutral-600" />
          ...
          <div className="space-y-2">
            ...
            <Input id="logInterval" type="number" value={settings.logInterval} onChange={e => onSettingChange('logInterval', e.target.value)} className="bg-neutral-700 border-neutral-600" />
