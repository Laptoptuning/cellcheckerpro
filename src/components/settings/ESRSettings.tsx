      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input id="pulseCurrent" type="number" step="0.1" value={settings.pulseCurrent} onChange={e => onSettingChange('pulseCurrent', e.target.value)} className="bg-neutral-700 border-neutral-600" />
          ...
          <div className="space-y-2">
            ...
            <Input id="pulseLength" type="number" value={settings.pulseLength} onChange={e => onSettingChange('pulseLength', e.target.value)} className="bg-neutral-700 border-neutral-600" />
          ...
          <div className="space-y-2">
            ...
            <Input id="measurements" type="number" value={settings.measurements} onChange={e => onSettingChange('measurements', e.target.value)} className="bg-neutral-700 border-neutral-600" />
